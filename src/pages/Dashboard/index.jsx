  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-gilroy sm:gap-10 md:gap-10 gap-[120px] items-center justify-start mx-auto w-full">
        <div className="h-[1286px] md:h-[1691px] sm:h-[3346px] md:px-5 relative w-full">
          <div className="absolute bg-white-A700 bottom-[0] flex flex-col items-center justify-start m-auto p-[38px] sm:px-5 right-[0] w-4/5">
            <div className="flex flex-col items-center justify-start m-auto w-full">
              <div className="md:gap-5 gap-6 grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 justify-center m-auto min-h-[auto] w-full">
                <div className="bg-white-A700 border border-blue_gray-200 border-solid flex flex-1 flex-col gap-4 h-[533px] md:h-auto items-end justify-start m-auto p-2.5 rounded-[23px] w-full">
                  <Img
                    className="h-[265px] sm:h-auto m-auto object-cover rounded-[12px] w-full"
                    src="images/img_placeholder.png"
                    alt="placeholder"
                  />
                  <div className="flex flex-col gap-4 items-start justify-start m-auto w-auto">
                    <Text
                  ...
                  <div className="flex flex-row gap-2 items-center justify-between m-auto w-[323px]">
                    ...
                    <Text
                      className="m-auto text-blue_gray-700 text-right text-sm w-auto"
                      size="txtGilroyMedium14"
                    >
                      22nd June, 2022
                    </Text>
          ...
          <div className="absolute bg-white-A700 border-b border-blue_gray-100 border-solid flex md:flex-col flex-row md:gap-10 items-center justify-between m-auto p-4 right-[0] top-[0] w-[79%]">
            <div className="flex flex-col items-center justify-start md:ml-[0] ml-[15px] w-[31%] md:w-full">
              <div className="bg-white-A700 flex flex-row gap-6 items-start justify-start w-auto">
                <div className="flex flex-col items-center justify-start w-auto">
                  <Text
                    className="common-pointer m-auto text-base text-center text-gray-900_01 w-auto"
                ...
                <div className="flex flex-col items-center justify-start w-auto">
                  <Text
                    className="common-pointer m-auto text-base text-center text-gray-900_99 w-auto"
          ...
          <div className="absolute bg-white-A700 border-b border-blue_gray-100 border-r border-solid flex flex-col font-opensans gap-[54px] h-[1024px] md:h-auto items-center justify-end left-[0] m-auto p-[17px] sm:px-5 top-[0] w-[278px]">
            <Img
              className="h-[41px] w-[215px]"
              src="images/img_frame9873.svg"
              alt="frame9873"
            />
            <div className="flex flex-col h-[895px] md:h-auto items-start justify-start m-auto w-auto">
              <div className="flex flex-col items-start justify-start w-auto">
                <div className="flex flex-col items-center justify-start w-full">
                  <div className="flex flex-col gap-2 items-start justify-start m-auto w-full">
                    <Text
