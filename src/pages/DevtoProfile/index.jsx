      ...
      <div className="bg-gray-50 flex flex-col font-gilroy items-center justify-start mx-auto w-full">
        <div className="bg-white-A700 flex flex-col justify-start w-full">
          <header className="flex flex-col items-center justify-center md:px-5 w-full">
            <div
              className="common-pointer border-b border-blue_gray-100 border-solid flex md:flex-col flex-row md:gap-10 items-center justify-between m-auto p-[17px] w-full"
          ...
          <div className="border border-blue_gray-100 border-solid flex flex-col gap-5 items-center justify-start m-auto max-w-[676px] md:px-5 px-[140px] py-8 rounded-lg w-full">
          ...
          <List
            className="flex flex-col gap-4 items-center mt-auto mx-auto md:px-5 w-[47%]"
            orientation="vertical"
          >
            <div className="bg-white-A700 border border-blue_gray-200 border-solid flex md:flex-col flex-row gap-4 items-end justify-start m-auto max-w-[676px] p-2.5 rounded-lg w-full">
              <Img
                className="md:flex-1 md:h-[212px] sm:h-auto h-full m-auto object-cover rounded-[12px] w-[306px] md:w-full"
              ...
              <div className="flex flex-col gap-2 items-end justify-start w-auto">
                <div className="flex flex-col gap-1 items-start justify-start w-auto">
                  <Text
                    className="leading-[33.00px] m-auto max-w-[318px] md:max-w-full text-gray-900 text-xl"
                    size="txtGilroyBold20"
                  >
                    How to create a UX Writing portfolio as a beginner
                  </Text>
                  <Text
                    className="leading-[26.00px] m-auto max-w-[312px] md:max-w-full text-base text-gray-900"
                ...
                <div className="flex flex-row gap-2 items-center justify-between m-auto w-[278px]">
                  <div className="flex flex-row gap-2 items-center justify-start m-auto w-auto">
                    <div className="flex flex-col h-14 items-center justify-start w-14">
                      <Img
                        className="h-14 md:h-auto m-auto rounded-[50%] w-14"
            ...
            <div className="bg-white-A700 border border-blue_gray-200 border-solid flex md:flex-col flex-row gap-4 items-end justify-start m-auto max-w-[676px] p-2.5 rounded-lg w-full">
              ...
              <div className="flex flex-col gap-2 items-end justify-start w-auto">
                <div className="flex flex-col gap-1 items-start justify-start w-auto">
                  ...
                  <Text
                    className="leading-[26.00px] m-auto max-w-[310px] md:max-w-full text-base text-gray-900"
                    size="txtGilroyRegular16"
                  >
                    The film rolls back the clock through Nike’s past as the
                    company expands sport for a new generation over the next
