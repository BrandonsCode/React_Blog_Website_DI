      ...
      <div className="bg-gray-50 flex flex-col font-gilroy items-center justify-start mx-auto w-full">
        <div className="bg-white-A700 flex flex-col justify-start w-full">
          <header className="flex flex-col items-center justify-center md:px-5 w-full">
            <div className="border-b border-blue_gray-100 border-solid flex md:flex-col flex-row md:gap-10 items-center justify-between m-auto p-[17px] w-full">
          ...
          <div className="border border-blue_gray-100 border-solid flex flex-col items-center justify-start m-auto max-w-[676px] md:px-5 px-[140px] py-8 rounded-lg w-full">
          ...
          >
            <div className="bg-white-A700 border border-blue_gray-200 border-solid flex md:flex-col flex-row gap-4 items-start justify-start m-auto max-w-[676px] p-2.5 rounded-lg w-full">
              <Img
