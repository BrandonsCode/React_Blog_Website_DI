          ...
          <div className="flex flex-col gap-8 items-center justify-start w-full">
                ...
                <div className="flex flex-col items-center justify-start ml-[15px] w-[10%]">
                  <div className="flex flex-col items-start justify-start w-auto">
                    <div className="flex flex-col items-center justify-start w-auto">
                      <Text
                        className="m-auto text-center text-gray-900_01 text-xl w-auto"
            ...
            <div className="flex md:flex-col flex-row gap-6 items-start justify-start max-w-[1376px] mx-auto md:px-5 w-full">
              <div className="flex md:flex-1 flex-col gap-6 items-center justify-start w-[67%] md:w-full">
                <Text
                  className="border border-blue_gray-100 border-solid h-[90px] m-auto max-w-[909px] md:max-w-full pl-8 pr-[35px] sm:px-5 py-5 rounded-lg sm:text-4xl md:text-[38px] text-[40px] text-blue_gray-300 w-full"
                  size="txtGilroyMedium40"
                >
                  Title
                </Text>
                <div className="border border-blue_gray-100 border-solid flex flex-col h-[753px] md:h-auto items-start justify-start m-auto max-w-[909px] p-8 sm:px-5 rounded-lg w-full">
                  <Text
              ...
              <div className="flex md:flex-1 flex-col gap-6 items-center justify-start w-[33%] md:w-full">
                <div className="flex flex-col gap-2 items-start justify-start m-auto w-auto sm:w-full">
                  <Text
